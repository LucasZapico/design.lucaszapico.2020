        ...
        <div className="container__content style-guide">
          ...
          <section className="section">
            ...
            <div className="">
              ...
              <div className="body__large char__readable margin__y">
                ...
                reprehenderit. Nisi magna occaecat ullamco enim
                aliquip ipsum consectetur non tempor mollit sunt id.
                Ut id velit ut laborum ipsum minim labore.
              </div>
          ...
          <section className="section margin__y--l">
            ...
            <div className="container__card">
              <div className="padding__y--m">
                <Link
                  to="/"
                  className="link__pri--light link link__icon  margin__left--m"
                >
                  Link <IoIosRocket />
                </Link>
              </div>
          ...
          <section className="section margin__y--l">
            ...
            <h3 className="h5">Card Post</h3>
            <div className="container__card">
              <div className={`post card post-img`}>
                <div className="post__img"></div>
                <div className="post__content">
                  <div className="post__header">
                    <h4 className="post__title">
                      o elit commodo irure
                    </h4>
                  </div>
                  <div className="post__body">
                    <h6 className="post__title">
                      Exercitation ipsum deserunt sunt ex aliquip
