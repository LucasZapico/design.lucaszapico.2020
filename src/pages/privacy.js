...
const PrivacyPage = ({ children }) => {
  ...
  const author = site.siteMetadata.author || author
  return (
    <Layout>
      <div className="char__readable center margin__y--l">
        <h2>Privacy Policy</h2>
        <p>
          Your privacy is important to us. It is {author} policy to
          respect your privacy regarding any information we may
          collect from you across our website,{' '}
          <a href={siteUrl}>{siteUrl}</a>, and other sites we own and
          operate.
        </p>
        <p>
